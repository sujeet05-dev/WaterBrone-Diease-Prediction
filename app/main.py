...
class PredictionRequest(BaseModel):
    ...
    sodium: float = Field(135.0, ge=0, le=200, description="Sodium (mmol/L)")
    potassium: float = Field(4.1, ge=0, le=10, description="Potassium (mmol/L)")
    chloride: float = Field(98.0, ge=0, le=150, description="Chloride (mmol/L)")
    wbc: float = Field(8.0, ge=0, le=100, description="WBC count (×10⁹/L)")
    hemoglobin: float = Field(13.0, ge=0, le=20, description="Hemoglobin (g/dL)")
    platelets: float = Field(250.0, ge=0, le=1000, description="Platelets (×10⁹/L)")
    urea: float = Field(13.5, ge=0, le=100, description="Urea (mg/dL)")
    creatinine: float = Field(0.8, ge=0, le=5, description="Creatinine (mg/dL)")
    bilirubin: float = Field(0.7, ge=0, le=5, description="Bilirubin (mg/dL)")
    alt: float = Field(25.0, ge=0, le=200, description="ALT (U/L)")
    ast: float = Field(28.0, ge=0, le=200, description="AST (U/L)")
    age: int = Field(35, ge=0, le=120, description="Patient age (years)")
